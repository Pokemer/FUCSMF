...
(
    ...
    std::function<double(double*, INT)> value,  /* f = value (x, n) */
    std::function<void(double*, double*, INT)> grad, /* grad (g, x, n) */
    std::function<double(double*, double*, INT)> valgrad, /* f = valgrad (g, x, n), */
